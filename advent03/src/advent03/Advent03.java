...
public class Advent03 {
	...
	public static void main(String[] args) {
		...
		for (String s: resultMap.keySet()) {
			...
			int sub = wire1map.get(s) + wire2map.get(s);
	...
	private static Map<String, Point> getWireMap(String[] wireArr) {
		int x = 0;
		int y = 0;
		Map<String, Point> wireMap = new HashMap<String, Point>();
		
		for (String instruction : wireArr) {
			...
			for (int i = 0; i < length; i++) {
				...
				wireMap.put(String.valueOf(x) + ":" + String.valueOf(y), new Point(x, y));
			}
	...
	private static Map<String, Integer> getWireStepMap(String[] wireArr) {
		int x = 0;
		int y = 0;
		...
		for (String instruction : wireArr) {
			...
			for (int i = 0; i < length; i++) {
				...
				if (!wireMap.containsKey(String.valueOf(x) + ":" + String.valueOf(y))) {
					wireMap.put(String.valueOf(x) + ":" + String.valueOf(y), steps);
				}
